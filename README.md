...
# 示例：使用下载好的上述数据集在sd14权重上finetuning
 ./scripts/train.sh   --data_path dataset/train   --eval_data_path dataset/test_sdv4  --resume checkpoints/sd14_train.pth   --output_dir results/sd14_finetune   --use_freq_sens_cbp True  --cbp_replacement_rate 1e-5   --freq_sens_lambda 0.5 --blr 1e-5
