...
def evaluate(data_loader, model, device, use_amp=False):
    ...
    # Gather predictions and labels from all processes (for distributed training)
    # or use local predictions/labels (for single GPU training)
    if utils.is_dist_avail_and_initialized():
        ...
        # Single GPU mode: use local predictions and labels directly
